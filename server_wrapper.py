...
async def speak(req: TTSRequest, x_auth_token: str = Header(default="")):
    ...
    # NOTA: Higgsfield model_not_found — desabilitar por enquanto
    # Usar ElevenLabs ou voz nativa do navegador como fallback
    raise HTTPException(
        status_code=503, 
        detail="Higgsfield desabilitado temporariamente — use ElevenLabs ou voz nativa"
    )
